...
d = 0.055;
J = pi*d^3*h/8;
L = 4 ; % длина трубопровода
A1 = 0.2; % демпфирует  ВЧ
A2 = 100; % демпфирует все частоты
A3 = 1800;
A = 0.04; % сечение трубопровода
%a4 = E.*J./p0./A;
%M = pi*(d/2-h).^2*p0;
M = p0 * pi * d * h * 1.4; % масса трубопровода
a4 = E.*J./M;
ZZ = 0;
N = 1; % число импульсов
x1 = L/9
...
for I = 1:N
    ...
    Time = 0.3; % длительность сигнала, с
    Tb = 0.00004;
    t = 0.000022;
...
%plot (t,YY); % сигнал от времени
audiowrite('ModelOfDefect_6.wav',ZZ,Fd);
